...
public class UserServiceTest extends IntegrationTestBase {
    ...
    class Describe_Register {
        ...
        void randomPasswordGenerateTest() {
            ...
            assertThat(randomPassword.length()).isBetween(Constants.MIN_PASSWORD_SIZE, Constants.MAX_PASSWORD_SIZE);
        ...
        class Context_register_new_member {
            ...
            void It_returns_firebase_custom_token(String username, String email, String nickname) throws FirebaseAuthException {
                ...
                try {
                    ...
                    throw new RuntimeException("Cannot delete Firebase user! ==> uid: " + userRegisterDto.getUsername());
                }
            }
        }
