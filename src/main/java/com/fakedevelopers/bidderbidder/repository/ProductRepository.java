...
public interface ProductRepository extends JpaRepository<ProductEntity, Long> {
  ...
  List<ProductEntity> findAllByProductIdIsLessThanOrderByProductIdDesc(long productId,
      Pageable pageable);

  List<ProductEntity> findAllByProductTitleContainingIgnoreCaseAndProductIdIsLessThanOrderByProductIdDesc(
      String searchWord, long productId, Pageable pageable);

  List<ProductEntity> findAllByProductContentContainingIgnoreCaseAndProductIdIsLessThanOrderByProductIdDesc(
      String searchWord, long productId, Pageable pageable);
  ...
  List<ProductEntity> searchProductByTitleAndContentInInfiniteScroll(String searchWord,
      long productId, Pageable pageable);

  List<ProductEntity> findAllByProductTitleContainingIgnoreCase(String searchWord,
      Pageable pageable);

  List<ProductEntity> findAllByProductContentContainingIgnoreCase(String searchWord,
      Pageable pageable);
  ...
  long countAllByProductTitleContainingIgnoreCaseOrProductContentContainingIgnoreCase(String title,
      String content);
